    ...
    <div className="min-h-screen bg-background font-sans overflow-x-hidden">
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="relative bg-gradient-to-br from-honey/10 via-honey/5 to-pastel-lavender/10 rounded-3xl p-12 text-center border border-honey/20 overflow-hidden">
          ...
          <div className="absolute top-[70%] left-[40%] text-3xl opacity-10 animate-float" style={{ animationDelay: "1.8s" }}>✨</div>
          <div className="absolute top-[10%] right-[35%] text-4xl opacity-10 animate-float" style={{ animationDelay: "2.2s" }}>🛒</div>
          ...
          <div className="absolute top-[55%] right-[12%] w-10 h-10 border-2 border-honey/15 rotate-30" style={{ clipPath: "polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)" }} />
          <div className="absolute bottom-8 left-[45%] w-8 h-8 border-2 border-pastel-mint/15 -rotate-20" style={{ clipPath: "polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)" }} />
          ...
          <div className="absolute top-[18%] left-[45%] w-1.5 h-1.5 bg-honey/45 rounded-full animate-pulse" style={{ animationDelay: "0.9s" }} />
          <div className="absolute bottom-[15%] left-[15%] w-2 h-2 bg-pastel-lavender/40 rounded-full animate-pulse" style={{ animationDelay: "1.3s" }} />
          <div className="absolute top-[75%] right-[35%] w-1.5 h-1.5 bg-honey-light/35 rounded-full animate-pulse" style={{ animationDelay: "0.4s" }} />
          
          {/* Floating rings */}
          <div className="absolute top-[12%] left-[50%] w-8 h-8 border border-honey/20 rounded-full animate-float" style={{ animationDelay: "0.6s" }} />
          <div className="absolute bottom-[18%] right-[45%] w-6 h-6 border border-pastel-pink/25 rounded-full animate-float" style={{ animationDelay: "1.4s" }} />
          <div className="absolute top-[65%] left-[12%] w-10 h-10 border border-honey/15 rounded-full animate-float" style={{ animationDelay: "2.1s" }} />
